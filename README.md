...
│ ├── \_components.scss # 跨頁面小組件樣式 (如果沒寫在 .vue 裡)
...
│ │  
│ └── contact/ # ---聯絡我們子模組 ---
│ ├── ContactInbox.vue # 10. 聯絡我們收件夾
│ └── ContactDetail.vue # 11. 訊息內容
│  
├── App.vue # 根組件 (掛載全域燈箱、Loading 條)
└── main.js # 專案初始化 (掛載 Element Plus, Pinia)
```
